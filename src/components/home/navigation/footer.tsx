        ...
        <footer className="flex flex-col relative items-center justify-center border-t border-border pt-16 pb-8 px-6 lg:px-8 w-full max-w-6xl mx-auto lg:pt-32">
                ...
                <div className="grid-cols-2 gap-8 grid mt-16 xl:col-span-2 xl:mt-0">
                    <div className="md:grid md:grid-cols-2 md:gap-8">
                        ...
                        <div className="mt-10 md:mt-0 flex flex-col">
                            ...
                            <ul className="mt-4 text-sm text-muted-foreground">
                                <li className="">
                                    <Link href="https://facebook.com/cvcoders" className="hover:text-foreground transition-all duration-300">
                                        Facebook
                                    </Link>
                                </li>
                                <li className="mt-2">
                                    <Link href="https://www.instagram.com/cv.coders/" className="hover:text-foreground transition-all duration-300">
                                        Instagram
                                    </Link>
                                </li>
                                <li className="mt-2">
                                    <Link href="https://www.youtube.com/@Cvcoders" className="hover:text-foreground transition-all duration-300">
                                        Youtube
                                    </Link>
                                </li>
                                <li className="mt-2">
            ...
            <div className="mt-8 border-t border-border/40 pt-4 md:pt-8 md:flex md:items-center md:justify-between w-full">
                <p className="text-sm text-muted-foreground mt-8 md:mt-0">
                    &copy; {new Date().getFullYear()} CVCoders INC. All rights reserved.
                </p>
            </div>
